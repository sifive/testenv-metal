...
/** Dummy structure to return values in registers t0/t1 */
struct stack_return
{
    uintptr_t sr_argc; /**< t0: argc */
    uintptr_t sr_argv; /**< t1: argv */
};
...
load_cmdline(void)
{
    ...
    struct stack_return sr = {
        .sr_argc = (uintptr_t)_cmdline_argc,
        .sr_argv = (uintptr_t)_cmdline_argv,
    };
