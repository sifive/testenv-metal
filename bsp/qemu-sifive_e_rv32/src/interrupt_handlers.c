...
void metal_sifive_hca0_source_0_handler(void) __attribute__((weak, alias ("_metal_global_interrupt_handler_nop")));
void metal_sifive_hca0_source_1_handler(void) __attribute__((weak, alias ("_metal_global_interrupt_handler_nop")));
